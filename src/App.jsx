  ...
  return (
    <main>
      <div id="game-container">
        ...
        {(winner || hasDraw) && <GameOver handleReset={handleReset} winner={winner} />}
        <GameBoard board={gameBoard} turns={gameTurns} activePlayerSymbol={activePlayer} onSelectSquare={handleSelectSquare}></GameBoard>
      </div>
      <Log turns={gameTurns} />
    </main>
  )
